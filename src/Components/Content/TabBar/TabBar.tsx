...
export default function TabBar() {
  ...
  return (
    ...
    <FullWidthTab value={value} key={0} index={0} dir={theme.direction}><Emails/> </FullWidthTab>
    <FullWidthTab value={value} key={1} index={1} dir={theme.direction}><Emails/> </FullWidthTab>
    </Box>
  );
}
